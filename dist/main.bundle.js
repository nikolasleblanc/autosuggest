...
module.exports = "<input #autosuggest type=\"text\" [formControl]=\"name\"/>\n\n<ul>\n  <li *ngFor=\"let result of results | async\">{{ result }}</li>\n</ul>"
...
var AppComponent = (function () {
    function AppComponent(http) {
        ...
        this.title = 'app';
        this.getResults = function (str) {
            return _this.http.get("search/" + str).map(function (res) { return res.json(); });
        };
        this.results = this.name.valueChanges.switchMap(function (e) { return _this.getResults(e); });
    }
    return AppComponent;
}());
